...
const translations: Record<Language, TranslationKeys> = {
  pt: {
    ...
    'about.work.achievement.1': 'Liderar o desenvolvimento e a operação do gateway: API REST, PIX/cartão/boleto, documentação e onboarding de parceiros.',
    'about.work.achievement.2': 'Desenvolver e manter os SDKs oficiais (Node, Python, PHP) e o middleware Hopy Split para facilitar a integração dos parceiros.',
    'about.work.achievement.3': 'Construir e manter o dashboard administrativo, webhooks e ferramentas internas para operação e suporte.',
  ...
  en: {
    ...
    'about.work.achievement.1': 'Lead the development and operation of the gateway: REST API, PIX/card/boleto, documentation and partner onboarding.',
    'about.work.achievement.2': 'Develop and maintain official SDKs (Node, Python, PHP) and the Hopy Split middleware to simplify partner integration.',
    'about.work.achievement.3': 'Build and maintain the admin dashboard, webhooks and internal tools for operations and support.',
    'about.work.achievement.4': 'Liderança técnica e estratégica na construção de um gateway de pagamentos do zero, focando em integrações com parceiros comerciais e adquirentes.',
    'about.work.achievement.5': 'Desenvolvimento e implementação de novas tecnologias para processamento de pagamentos e integração com múltiplos provedores.',
    'about.work.achievement.6': 'Alcançou R$ 504 milhões em faturamento processado em um único ano, demonstrando escalabilidade e confiabilidade da plataforma.',
